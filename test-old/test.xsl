...
>
    ...
    <xsl:call-template name="test_xml2json" />
    <!--<xsl:call-template name="test_xml2json_attr" />-->
  ...
  <xsl:template name="test_xml2json">
    <xsl:call-template name="xml2json">
	...
	<xsl:template name="test_xml2json_attr">
		<div>
			<xsl:call-template name="xml2json_attr">
				<xsl:with-param name="data">
					<root>
            <!--<elem width="640" src="http://www.google.com/" />-->
            <elem width="640" src="http://www.youtube.com/embed/BURsVn_abJY">
              <xsl:text>super\fdsafas\"fsajdl\\"ajfdsa\\'</xsl:text>
            </elem>
					</root>
				</xsl:with-param>
